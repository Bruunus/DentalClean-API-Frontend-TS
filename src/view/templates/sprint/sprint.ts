...
export class Sprint {
    ...
    //tela com título em vermelho 'sprint'
    /* 
        botão 'Sprint' - ao clicar no button visibilizar um imput para o nome da sprint e ao lado criar um button 'Criar' - após criar 
        fechar visibilidade do input e do button
    */

    /* cria tabela para visibiliar as sprints criadas
        cada row deve conter:
            -   nome da sprint
            -   data de criação (sistema deve pegar no momento da criação da sprint)
            -   criar dois botões:
                - Concluir
                - Excluir

                * Evento Concluir: Retirar a sprint concluida da tabela e mover para a tabela de histórico
                * Evento Excluir: deleta a sprint 
            
    */

    /* 
        Criar uma tabela histório - que fique oculta com o botão 'mostrar' 

            * Evento mostrar: exibe a tabela de histórico das sprints
                - cada row deve ter 
                    -   nome da sprint
                    -   data de criação (sistema deve pegar no momento da criação da sprint)
                    -   botão 'Ressucitar' - Evento que traga a sprint novamente para a tabela sprint
